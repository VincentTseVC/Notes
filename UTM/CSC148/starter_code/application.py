...
def process_event_history(log: dict[str, list[dict]],
    ...
    for event_data in log['events']:
        ...
        if event_data['type'] == 'call':
            ...
            call = Call(
                event_data['src_number'],
                event_data['dst_number'],
                date,
                event_data['duration'],
            ...
            find_customer_by_number(call.src_number, customer_list).make_call(call)
            find_customer_by_number(call.dst_number, customer_list).receive_call(call)
