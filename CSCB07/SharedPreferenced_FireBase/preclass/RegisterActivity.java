...
//
//                } else {
//                    Toast.makeText(RegisterActivity.this, "Bad", Toast.LENGTH_LONG).show();
//                }
//            }
//        });
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            FirebaseDatabase.getInstance().getReference("Users")
                                    .child(FirebaseAuth.getInstance().getCurrentUser().getUid())    // get the current registered user id
                                    .setValue(user).addOnCompleteListener(new OnCompleteListener<Void>() {  // always good idea to have onComplete
                                @Override
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()) {
